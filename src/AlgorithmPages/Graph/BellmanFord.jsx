...
function BellmanFord() {
  ...
  const [edgesInput, setEdgesInput] = useState('A-B:4, A-D:2, B-C:-3, B-D:5, C-E:2, D-E:10');
  ...
  // Preset examples
  const examples = [
    { name: 'Default (Negative)', nodes: 'A, B, C, D, E', edges: 'A-B:4, A-D:2, B-C:-3, B-D:5, C-E:2, D-E:10' },
    { name: 'Simple', nodes: 'A, B, C, D', edges: 'A-B:1, A-C:4, B-C:2, B-D:-2, C-D:1' },
    { name: 'Mixed Weights', nodes: 'A, B, C, D, E, F', edges: 'A-B:5, A-C:2, B-D:-1, C-D:4, C-E:3, D-E:-2, D-F:1, E-F:3' }
  ];
    ...
    try {
      ...
      if (edgesStr.trim().length > 0) {
        ...
        for (let i = 0; i < edgePairs.length; i++) {
          ...
          if (isNaN(weight)) {
            setErrorMessage(`Invalid weight in edge "${edgePairs[i]}". Weight must be a number (can be negative).`);
            return false;
          }
  ...
  const generateRandomGraph = () => {
    ...
    // Create random edges with random weights (including negatives)
    const edges = [];
    ...
    for (let i = 0; i < edgeCount; i++) {
      ...
      const weight = isNegative ? -(1 + Math.floor(Math.random() * 5)) : (1 + Math.floor(Math.random() * 9));
  ...
  const resetToDefault = () => {
    ...
    setEdgesInput('A-B:4, A-D:2, B-C:-3, B-D:5, C-E:2, D-E:10');
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-lg text-sm"
                    placeholder="e.g., A-B:4, B-C:-3, C-D:2"
                    disabled={isRunning}
                  />
                </div>
                ...
                <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                  ...
                  <ul className="text-blue-700 text-xs space-y-1 ml-4">
                    ...
                    <li>• Negative weights are allowed (use -3, -5, etc.)</li>
