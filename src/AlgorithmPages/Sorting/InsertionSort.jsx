...
function InsertionSort() {
  ...
  const insertionSort = useCallback(() => {
    ...
    operationSteps.push({
      type: 'initialize',
      message: `Starting Insertion Sort with array: [${arr.join(', ')}]`,
      array: [...arr],
      current: null,
      comparing: [],
      inserting: null,
      stats: { comparisons: 0, shifts: 0, pass: 0 }
    });
    ...
    for (let i = 1; i < n; i++) {
      ...
      operationSteps.push({
        type: 'select_key',
        message: `Selected key = arr[${i}] = ${key} to insert`,
        array: [...arr],
        current: i,
        comparing: [],
        inserting: null,
        stats: { comparisons, shifts, pass: i }
      });
      ...
      while (j >= 0 && arr[j] > key) {
        ...
        operationSteps.push({
          type: 'comparing',
          message: `Comparing arr[${j}]=${arr[j]} with key=${key}. arr[${j}] > key, need to shift`,
          array: [...arr],
          current: i,
          comparing: [j, i],
          inserting: null,
        ...
        operationSteps.push({
          type: 'shifting',
          message: `Shifted arr[${j}]=${arr[j + 1]} to position ${j + 1}`,
          array: [...arr],
          current: i,
          comparing: [j + 1],
          inserting: null,
      ...
      operationSteps.push({
        type: 'insert',
        message: `Inserted ${key} at index ${j + 1}. Pass ${i} complete.`,
        array: [...arr],
        current: i,
        comparing: [],
        inserting: j + 1,
    ...
    operationSteps.push({
      type: 'complete',
      message: `✓ Insertion Sort Complete! Total comparisons: ${comparisons}, Total shifts: ${shifts}`,
      array: [...arr],
      current: null,
      comparing: [],
      inserting: null,
      stats: { comparisons, shifts, pass: n - 1 }
    });
  ...
  const handleSort = () => {
    const operationSteps = insertionSort();
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-8 flex flex-wrap justify-center gap-2 min-h-64">
              {array.map((num, idx) => {
                const isCurrent = currentStepData.current === idx;
                const isComparing = currentStepData.comparing?.includes(idx);
                const isInserting = currentStepData.inserting === idx;
                ...
                return (
                  <div
                    ...
                    className={`w-14 h-14 flex items-center justify-center rounded-lg font-bold text-lg transition-all transform ${
                      isCurrent
                        ? 'bg-blue-400 dark:bg-blue-600 scale-110 shadow-lg'
                        : isInserting
                        ? 'bg-purple-400 dark:bg-purple-600 scale-110 shadow-lg'
                        : isComparing
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900 dark:to-purple-900 rounded-lg p-4 border-2 border-blue-300 dark:border-blue-700">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600 dark:text-green-400">{currentStepData.stats?.shifts || 0}</p>
                </div>
                <div>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border-2 border-gray-300 dark:border-gray-600">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded bg-blue-400 dark:bg-blue-600"></div>
                  <span className="text-sm text-gray-700 dark:text-gray-300">Current Key</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300">Inserting</span>
                </div>
              </div>
            </div>
          </div>
  ...
  const TheorySection = () => (
    <div className="bg-white/95 dark:bg-gray-800 rounded-lg p-6 shadow-lg space-y-6">
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-xl font-semibold mb-2">What is Insertion Sort?</h3>
          <p className="text-gray-700 dark:text-gray-300">
            Insertion Sort is a simple comparison-based sorting algorithm that builds the final sorted array one item at a time. It iterates through an input array, and for each iteration, it removes one element from the array and finds the place it belongs in the sorted part of the array.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 dark:bg-blue-900 rounded-lg p-4 border-l-4 border-blue-500">
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300 text-sm">
              ...
              <li>Insert at correct position</li>
          ...
          <div className="bg-green-50 dark:bg-green-900 rounded-lg p-4 border-l-4 border-green-500">
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300 text-sm">
              ...
              <li>Adaptive (efficient for nearly sorted)</li>
        ...
        <div className="bg-purple-50 dark:bg-purple-900 rounded-lg p-4">
          ...
          <div className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
            ...
            <p className="ml-4">• Take the current element as the key</p>
            <p className="ml-4">• Compare with elements to the left</p>
            <p className="ml-4">• Shift larger elements to the right</p>
            <p className="ml-4">• Insert key at correct position</p>
          </div>
        </div>
        ...
        <div className="bg-orange-50 dark:bg-orange-900 rounded-lg p-4">
          ...
          <div className="space-y-2 text-gray-700 dark:text-gray-300 text-sm font-mono">
            ...
            <p className="text-xs">Best: O(n), Worst: O(n²), Average: O(n²)</p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-green-50 dark:bg-green-900 rounded-lg p-4 border border-green-200 dark:border-green-700">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700 dark:text-gray-300">
            ...
            <li>Many shifts needed</li>
            <li>Slower than advanced algorithms</li>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Watch the algorithm build the sorted array by inserting each element into its correct position.
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-6 text-center shadow-lg">
          <h3 className="text-xl font-bold mb-2">Master Sorting Algorithms! 📊</h3>
          <p>Insertion Sort is an adaptive algorithm that works efficiently on nearly sorted data and is great for learning fundamental sorting concepts.</p>
        </div>
      </div>
    </div>
  );
